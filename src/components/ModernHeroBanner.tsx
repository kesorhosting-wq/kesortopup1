        ...
        {hasMultipleImages && (
          <>
            <button
              ...
              className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 z-10 p-2 sm:p-3 bg-background/80 backdrop-blur-sm rounded-full border border-border hover:bg-gold hover:border-gold hover:text-primary-foreground transition-all duration-300 opacity-0 group-hover:opacity-100"
            ...
            <button
              ...
              className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 z-10 p-2 sm:p-3 bg-background/80 backdrop-blur-sm rounded-full border border-border hover:bg-gold hover:border-gold hover:text-primary-foreground transition-all duration-300 opacity-0 group-hover:opacity-100"
